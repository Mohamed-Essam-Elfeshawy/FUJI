...
import elevator_installation from '../images/OurServices/elevator_installation_2.jpeg'
import elevator_supply from '../images/OurServices/elevator_supply.jpeg'
import elevator_modiraizion from '../images/OurServices/maintenance_option_01.jpg'
import elevator_maintainence from '../images/OurServices/elevator_installation.jpg'
import elevator_tower_installation from '../images/OurServices/elevator_tower_option_01.jpg'
import elevator_consultation from '../images/OurServices/our_services_img_01.png'
...
// Why Shoose Us Icons
import answer from '../images/WhyChooseUs/icons/answer.png'
import discussion from '../images/WhyChooseUs/icons/discussion.png'
import favorites from '../images/WhyChooseUs/icons/favorites.png'
import medal from '../images/WhyChooseUs/icons/medal.png'
import medicine from '../images/WhyChooseUs/icons/medicine.png'
import pentool from '../images/WhyChooseUs/icons/pentool.png'
import skill from '../images/WhyChooseUs/icons/skill.png'
import warranty from '../images/WhyChooseUs/icons/warranty.png'

const Our_Services_Data = [
    {
        id: "01",
        img: elevator_installation,
        ...
        descriptionAR: "نقدم خدمات تركيب تلبي احتياجاتكم بدقة، بما في ذلك المصاعد المستوردة بالكامل والمصاعد الإيطالية بتصاميم كبائن مختلفة والسلالم الكهربائية وأنظمة السلامة وكاميرات المراقبة، مع ضمان أعلى معايير الجودة والأمان."
    },
    {
        id: "02",
        img: elevator_supply,
    ...
    {
        id: "05",
        img: elevator_tower_installation,
    ...
    },
    {
        ...
        contentTextColor: "#ffffff",
        borderColor: "#496071",
        descriptionEN: 'We offer consultation service to provide you with the best solutions and recommendations based on your needs by specialists.',
        descriptionAR: "نقدم خدمة الاستشارات لتزويدكم بأفضل الحلول والتوصيات بناءً على احتياجاتكم من قبل مختصين."
    },
]
...
const Why_Choose_Us_Data = [
    ...
    {
        titleEN: "Strong warranties",
        titleAR: "ضمانات عالية",
        icon: warranty
    },
    {
        titleEN: "Free consultations",
        titleAR: "استشارات مجانية",
        icon: discussion
    },
    {
        titleEN: "Modern designs",
        titleAR: "تصاميم عصرية",
        icon: pentool
    },
    {
        titleEN: "High safety standards",
        titleAR: "معايير سلامة عالية",
        icon: medicine
    },
    {
        titleEN: "A variety of options",
